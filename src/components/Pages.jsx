...
export default function Pages({ prevPage, nextPage, pageBefore, pageAfter }) {
  ...
  return (
    <Row className='justify-content-center my-4'>
      <Button className='col-1 mx-1' onClick={prevPage} disabled={disabledBefore}>Prev</Button>
      <Button className='col-1 mx-1' onClick={nextPage} disabled={disabledAfter}>Next</Button>
    </Row>
  );
}
